...
%Their obtained results indicated that combination of \ac{bow} representation and k-\ac{nn} classifier achieves the best performance with \ac{se} and \ac{sp} of 100$\%$ and 75$\%$, respectively.
...
In our previous work, using the same dataset, we compared the effects of various colors, shape and texture features and ensemble approaches~\cite{rastgoo2015ensemble}.
