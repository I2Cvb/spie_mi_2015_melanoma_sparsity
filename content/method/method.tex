...
\deleted[id=sik, remark="rules ABDE, are not lowlevel. The only lowlevel is color, so I don't think that this is the proper manner to bring the argument. We can just say what low-level refers and what high-level refers and when talking about color mention the abCde rule"]{
