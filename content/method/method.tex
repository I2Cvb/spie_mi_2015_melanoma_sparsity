...
As mentioned in the Sect.\,\ref{sec:descr}, the proposed framework, in comparison to previous methods (see Table~\ref{tab:rw}), do not rely on pre-processing an segmentation and focus only on feature detection, extraction and classification.
...
In this study, three low-level features in line with the previous two discriminative criteria are used.
