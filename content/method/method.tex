...
The classification is performed using a \ac{rf} classifier\footnotesize{The implementation used can be found at:\texttt{https://code.google.com/p/randomforest-matlab/}}.
